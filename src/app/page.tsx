...
export default function Home() {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center bg-zinc-800">
      ...
      <div className="space-y-4 min-w-[250px] text-center w-[40%] max-w-[400px] h-[30%] flex items-center justify-center flex-col border border-zinc-50 rounded-md shadow-md">
